...
describe('Binary instance methods', function () {
    ...
    describe('x / y -> x.divide(y)', function () {
        it('should be correct: (1 + 2i) / 2 == (.5 + 1i)', function () {
            expect(compInst.divide(testNumber)).to.eql(new ComplexNumber(.5, 1));
        });
        ...
        it('should be correct: (1 + 2i) / (0 + 2i) == (1 - .5i)', function () {
            expect(compInst.divide(testImag)).to.eql(new ComplexNumber(1, -.5));
        });

        it('should be correct: (1 + 2i) / (3 + 2i) == (1.4 + .8i)', function () {
            expect(compInst.divide(testComp)).to.eql(new ComplexNumber(1.4, .8));
        });

        it('should be correct: (1 + 2i) / (0 + 0i) == (NaN + NaN*i)', function () {
            var res = compInst.divide(testCompZero);

            // expect.eql does not understand NaN !== NaN
        ...
        it('should be correct: (1 + 0i) / 2 == (.5 + 0i)', function () {
            expect(realInst.divide(testNumber)).to.eql(new ComplexNumber(.5, 0));
        });
        ...
        it('should be correct: (1 + 0i) / (0 + 2i) == (0 - .5i)', function () {
            expect(realInst.divide(testImag)).to.eql(new ComplexNumber(0, -.5));
        });

        it('should be correct: (1 + 0i) / (3 + 2i) == (.6 - .4i)', function () {
            expect(realInst.divide(testComp)).to.eql(new ComplexNumber(.6, -.4));
        });
        ...
        it('should be correct: (0 + 2i) / (3 + 2i) == (.8 - .6i)', function () {
            expect(imagInst.divide(testComp)).to.eql(new ComplexNumber(.8, -.6));
        });
